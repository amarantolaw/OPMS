...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.feed_group'
        db.add_column('ffm_feed', 'feed_group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ffm.FeedGroup']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.feed_group'
        db.delete_column('ffm_feed', 'feed_group_id')
    ...
    models = {
        ...
        'ffm.feeddestination': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'OPMS-feed:f3205d49-6fbd-4532-8e19-6119e62ef879'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
        ...
        'ffm.file': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'OPMS-file:ba6cbacb-312f-4f6a-af8c-8327ec0df4a1'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ffm.item': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'OPMS-item:afcdb59d-751e-46b0-8dfe-f2809a6d918f'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_comments': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
