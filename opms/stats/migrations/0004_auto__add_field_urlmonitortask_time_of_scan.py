...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'ffm.item': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'OPMS-item:ddb1fd6f-33ec-42d1-b97f-31309840672f'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'stats.urlmonitortask': {
            ...
            'time_of_scan': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
