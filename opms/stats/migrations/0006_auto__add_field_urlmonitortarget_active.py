...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'URLMonitorTarget.active'
        db.add_column('stats_urlmonitortarget', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'URLMonitorTarget.active'
        db.delete_column('stats_urlmonitortarget', 'active')
    ...
    models = {
        ...
        'ffm.item': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'OPMS-item:2103ad05-b6c4-48b0-8623-1d6f67d75c22'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
